...
{
    public partial class MustaqilxatmirejasiForm1 : Form
    {
        public string text9;
        public string path = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\\Mustaqiloqilganlar.txt";
        public string pathditetime = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\\mustaqiloqish_satetime.txt";
        public string[] paths = new string[30];


        public string pathcheck = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\\chechbox.txt";
        public bool t1 = true;
        public MustaqilxatmirejasiForm1()
        {
            InitializeComponent();
        }
        private void textBox31_TextChanged(object sender, EventArgs e)
        {
            string text = textBox31.Text;
        }
        ...
        private void MustaqilxatmirejasiForm1_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 30; i++)
            {
                paths[i] = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\\Mustaqiloqilganlar1 - Copy" + i + ".txt";
            ...
            textBox31.Text = File.ReadAllText(paths[0]);
            textBox32.Text = File.ReadAllText(paths[1]);
            textBox33.Text = File.ReadAllText(paths[2]);
            textBox34.Text = File.ReadAllText(paths[3]);
            textBox35.Text = File.ReadAllText(paths[4]);
            textBox36.Text = File.ReadAllText(paths[5]);
            textBox37.Text = File.ReadAllText(paths[6]);
            textBox38.Text = File.ReadAllText(paths[7]);
            textBox39.Text = File.ReadAllText(paths[8]);
            textBox40.Text = File.ReadAllText(paths[9]);
            textBox41.Text = File.ReadAllText(paths[10]);
            textBox42.Text = File.ReadAllText(paths[11]);
            textBox43.Text = File.ReadAllText(paths[12]);
            textBox44.Text = File.ReadAllText(paths[13]);
            textBox45.Text = File.ReadAllText(paths[14]);
            textBox46.Text = File.ReadAllText(paths[15]);
            textBox47.Text = File.ReadAllText(paths[16]);
            textBox48.Text = File.ReadAllText(paths[17]);
            textBox49.Text = File.ReadAllText(paths[18]);
            textBox50.Text = File.ReadAllText(paths[19]);
            textBox51.Text = File.ReadAllText(paths[20]);
            textBox52.Text = File.ReadAllText(paths[21]);
            textBox53.Text = File.ReadAllText(paths[22]);
            textBox54.Text = File.ReadAllText(paths[23]);
            textBox55.Text = File.ReadAllText(paths[24]);
            textBox56.Text = File.ReadAllText(paths[25]);
            textBox57.Text = File.ReadAllText(paths[26]);
            textBox58.Text = File.ReadAllText(paths[27]);
            textBox59.Text = File.ReadAllText(paths[28]);
            textBox60.Text = File.ReadAllText(paths[29]);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strings.Add(textBox31.Text);
                strings.Add(textBox32.Text);
                strings.Add(textBox33.Text);
                strings.Add(textBox34.Text);
                strings.Add(textBox35.Text);
                strings.Add(textBox36.Text);
                strings.Add(textBox37.Text);
                strings.Add(textBox38.Text);
                strings.Add(textBox39.Text);
                strings.Add(textBox40.Text);
                strings.Add(textBox41.Text);
                strings.Add(textBox42.Text);
                strings.Add(textBox43.Text);
                strings.Add(textBox44.Text);
                strings.Add(textBox45.Text);
                strings.Add(textBox46.Text);
                strings.Add(textBox47.Text);
                strings.Add(textBox48.Text);
                strings.Add(textBox49.Text);
                strings.Add(textBox50.Text);
                strings.Add(textBox51.Text);
                strings.Add(textBox52.Text);
                strings.Add(textBox53.Text);
                strings.Add(textBox54.Text);
                strings.Add(textBox55.Text);
                strings.Add(textBox56.Text);
                strings.Add(textBox57.Text);
                strings.Add(textBox58.Text);
                strings.Add(textBox59.Text);
                strings.Add(textBox60.Text);
                ...
                if (strings[29] != "")
                {
                    ...
                    File.WriteAllText(paths[29], strings[29]);
                }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            File.WriteAllText(path6, "");
            File.WriteAllText(path7, "");
            File.WriteAllText(path8, "");
            File.WriteAllText(path9, "");
            File.WriteAllText(path10, "");
            File.WriteAllText(path11, "");
            File.WriteAllText(path12, "");
            File.WriteAllText(path13, "");
            File.WriteAllText(path14, "");
            File.WriteAllText(path15, "");
            File.WriteAllText(path16, "");
            File.WriteAllText(path17, "");
            File.WriteAllText(path18, "");
            File.WriteAllText(path19, "");
            File.WriteAllText(path20, "");
            File.WriteAllText(path21, "");
            File.WriteAllText(path22, "");
            File.WriteAllText(path23, "");
            File.WriteAllText(path24, "");
            File.WriteAllText(path25, "");
            File.WriteAllText(path26, "");
            File.WriteAllText(path27, "");
            File.WriteAllText(path28, "");
            File.WriteAllText(path29, "");
            File.WriteAllText(path30, "");*/
            textBox31.Text = File.ReadAllText(paths[0]);
            textBox32.Text = File.ReadAllText(paths[1]);
            textBox33.Text = File.ReadAllText(paths[2]);
            textBox34.Text = File.ReadAllText(paths[3]);
        ...
        public static string Sum(string text, string time)
        {
            try
            {
                string Natija = "Mustaqil xatm qilish : " + time + " Sanada " + " Qur'onning " + text + " qismlari ";
                return Natija;
            }
            catch
            {
